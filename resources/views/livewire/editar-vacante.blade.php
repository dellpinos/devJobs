<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <select wire:model.live="salario" id="salario"
            class="my-1 rounded-md shadow-sm border-gray-300 focus:border-blue-600 w-full dark:text-gray-300 dark:bg-gray-900">
    ...
    <div>
        ...
        <textarea
            class="my-1 rounded-md shadow-sm border-gray-300 focus:border-blue-600 w-full dark:text-gray-300 dark:bg-gray-900 h-52 "
            wire:model.live="descripcion" id="descripcion" placeholder="Descripción general del puesto y experiencia"></textarea>
